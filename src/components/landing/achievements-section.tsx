...
import { FiSearch, FiAward, FiLoader } from "react-icons/fi";
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 border-b border-white/10 pb-5 mb-5">
                    <div className="relative">
                      <div className="relative size-14 overflow-hidden rounded-full border-2 border-white/20 bg-[#0B0D19]">
                        <Image
                          src={member.imageSrc || "/teams/pfp.jpg"}
                          alt={member.name}
                          fill
