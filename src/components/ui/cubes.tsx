...
export interface CubesProps {
  ...
  cellGap?: number | { row?: number; col?: number } | string;
  borderStyle?: string;
  faceColor?: string;
...
export const Cubes: React.FC<CubesProps> = ({
  ...
  const colGap = typeof cellGap === 'number' ? `${cellGap}px` : typeof cellGap === 'object' && cellGap?.col !== undefined ? `${cellGap.col}px` : typeof cellGap === 'string' ? cellGap : '5%';
  const rowGap = typeof cellGap === 'number' ? `${cellGap}px` : typeof cellGap === 'object' && cellGap?.row !== undefined ? `${cellGap.row}px` : typeof cellGap === 'string' ? cellGap : '5%';
